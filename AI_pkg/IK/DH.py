...
def forward_kinematics(joint_angles, joint_lengths):
    ...
    """
    T_base_0 = dh_matrix(0, 0, 0, radians(-90))
    T_base_1 = dh_matrix(radians(90), 0, 0, radians(90))
...
end_position = forward_kinematics(JointAngles, JointLengths)
print("End Position:")
...
test_angle = calculate_ik(
        np.array([end_position[:3, 3]]), spotLeg
    )
print("IK Result:")
print(test_angle)