"""
The PPOConfig module contains the ppo_config class, which encapsulates all configuration
"""
...
class PPOconfig:
    ...
    for a spider robot.
    This includes settings related to model creation, loading, training, and environment
    configuration.
    ...
    Attributes:
        ...
        SAVE_MODEL_FREQUENCE (int): The frequency (in timesteps) at which the model is saved
        during training.
        TOTAL_TIME_STEPS (int): The total number of timesteps for training the PPO model.
        RESET_TOWARD_ANGLE_THRESHOLD (float) : The training step terminated threshold for
        training forward PPO. Represent the MAX angle tolarence between spider toward vector
        and z axis.
    ...
    # Load PPO model
    LOAD_MODEL_PATH: str = "./Model/PPO_spider_2024-09-11.pt"
