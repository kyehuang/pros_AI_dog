...
class KeyboardAction:
    ...
    KeyboardAction class
    """
    filename = "keyboard_control/keyboard_actions/motor_data_2025-03-13-1.pkl"
    with open(filename, "rb") as f:
        loaded_data = pickle.load(f)
    
    FORWARD_STEP_1 = loaded_data["FORWARD_STEP_1"]

    FORWARD_STEP_2 = loaded_data["FORWARD_STEP_2"]
    FORWARD_STEP_3 = loaded_data["FORWARD_STEP_3"]
