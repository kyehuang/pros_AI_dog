...
class KeyboardAction:
    ...
    FORWARD_STEP_2 = loaded_data_ik_craw["FORWARD_STEP_2"]
    FORWARD_STEP_3 = loaded_data_ik_craw["FORWARD_STEP_3"]
    
    FORWARD_STEP_4 = loaded_data_ik_craw["FORWARD_STEP_4"]
    FORWARD_STEP_5 = loaded_data_ik_craw["FORWARD_STEP_5"]
